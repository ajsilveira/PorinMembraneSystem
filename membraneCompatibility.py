...
class Modeller(app.Modeller):
    def changeAtomNames(self):

        atomsNames = {"N4":"N", "C1":"C13", "C2":"C14", "C3":"C15", "C5":"C12", "C6":"C11" ,"P8":"P","O9":"O13",\
"O10":"O14","O11":"O11","O7":"O12","C12":"C1","C13":"C2","O14":"O21","C15":"C21","O16":"O22","C32":"C3" ,\
"O33":"O31","C34":"C31","O35":"O32","C17":"C22","C18":"C23","C19":"C24","C20":"C25","C21":"C26","C22":"C27",\
"C23":"C28","C24":"C29","C25":"C210","C26":"C211","C27":"C212","C28":"C213","C29":"C214","C30":"C215",\
"C31":"C216","C36":"C32","C37":"C33","C38":"C34","C39":"C35","C40":"C36","C41":"C37","C42":"C38","C43":"C39",\
"C44":"C310","C45":"C311","C46":"C312","C47":"C313","C48":"C314","C49":"C315","C50":"C316"}
        ...
        # Change atom names to match AMBER definitions:
    ...
    def addHydrogens(self, forcefield=None, pH=7.0, variants=None, platform=None):
        self.loadHydrogenDefinitions('myhydrogens.xml')
